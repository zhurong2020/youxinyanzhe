...
- 📊 发布状态管理
  ...
  - 支持已发布文章的重新发布到其他平台
  - 防止重复发布到同一平台
  - 本地预览文件保存(`_output/wechat_previews/`)
...
- **重新发布**: 支持已发布文章发布到其他平台
- **防重复**: 自动过滤已发布的平台选项
- **本地预览**: 微信版本保存到`_output/wechat_previews/`
...
### 2025-07-15: 重大功能更新 🚀
- **微信公众号草稿保存**: 实现完整的微信发布流程，包括内容转换、图片上传、AI排版优化
- **多平台发布状态管理**: 新增发布状态跟踪系统，支持跨平台重新发布
- **本地预览功能**: 微信版本自动保存到本地供查看对比
