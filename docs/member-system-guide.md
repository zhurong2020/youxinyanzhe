...
| 等级 | 代码 | 价格 | 有效期 | Buy Me Coffee | 每月成本 | 权限 |
|------|------|------|--------|---------------|----------|------|
| 体验会员 | VIP1 | ¥5 | 7天 | - | - | 基础内容 |
| 月度会员 | VIP2 | ¥35 | 30天 | 1杯 ($5) | ¥35 | 全部内容 |
| 季度会员 | VIP3 | ¥108 | 90天 | 3杯 ($15) | ¥36 | 全部内容 + VIP专享 |
| 年度会员 | VIP4 | ¥180 | 365天 | 5杯 ($25) | ¥15 | 全部内容 + VIP专享 + 专属服务 |
...
```python
self.member_levels = {
    'premium': {'code': 'VIP5', 'days': 30, 'price': 99, 'name': '高级会员'},
    # 注意：实际使用的价格配置已更新为：
    # 'monthly': 35, 'quarterly': 108, 'yearly': 180
    # ... 其他等级
}
```
